...
public abstract class AirVRCameraBase : MonoBehaviour {
    ...
    protected PredictedHeadTrackerInputDevice headTracker { get; private set; }
    ...
    protected virtual void Awake() {
        ...
        headTracker = new PredictedHeadTrackerInputDevice(_thisTransform);
    }
    ...
    protected class PredictedHeadTrackerInputDevice : AirVRTrackerInputDevice {
        public PredictedHeadTrackerInputDevice(Transform camera) {
            _camera = camera;
        }
